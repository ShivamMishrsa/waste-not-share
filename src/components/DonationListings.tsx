  ...
  const listings = [
    {
      ...
      timeWindow: "Today, 4:00 PM - 5:00 PM",
      description: "Assorted pastries, bread, and cookies. Enough for 15-20 people.",
      image: "https://images.unsplash.com/photo-1465379944081-7f47de8d74ac?auto=format&fit=crop&w=600&h=400"
    },
    {
      id: 2,
      name: "Prepared Meals",
      restaurant: "Green Kitchen",
      location: "Midtown, Portland",
      timeWindow: "Today, 8:30 PM - 9:30 PM",
      description: "10 vegetarian pasta dishes and 8 salads. Refrigerated and ready to serve.",
      image: "https://images.unsplash.com/photo-1721322800607-8c38375eef04?auto=format&fit=crop&w=600&h=400"
    },
    {
      id: 3,
      name: "Sandwich Platters",
      restaurant: "Lunchbox Deli",
      location: "Westside, Eugene",
      timeWindow: "Tomorrow, 2:00 PM - 3:00 PM",
      description: "3 large platters with assorted sandwiches. Serves approximately 25 people.",
      image: "https://images.unsplash.com/photo-1465379944081-7f47de8d74ac?auto=format&fit=crop&w=600&h=400"
    },
  ];
